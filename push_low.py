...
def push_prototypes(dataloader,  # pytorch dataloader (must be unnormalized in [0,1])
    ...
    for push_iter, (search_batch_input, search_y, img_name) in enumerate(dataloader):
        ...
        with torch.no_grad():
            ...
            protoL_input_torch, proto_dist_torch = prototype_network_parallel.module.push_forward_low(search_batch)
    ...
    for j in range(n_prototypes):
        ...
        for push_idx in sorted_idx:
            ...
            with torch.no_grad():
                protoL_feat_torch, proto_dist_torch = prototype_network_parallel.module.push_forward_low(img_torch)
